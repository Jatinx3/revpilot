...
Requires psycopg (pip install psycopg[binary]). Set DATABASE_URL to point at the
live DB; the hardcoded default below is just a local-Postgres fallback.
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Postgres connection string (default: local Postgres fallback)",
    )
    parser.add_argument(
        "--manifest",
